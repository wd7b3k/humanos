...
RU: dict[str, str] = {
    ...
    "kb_proto_quit_ask": "⏹ Прервать практику",
    "kb_proto_quit_yes": "✋ Да, прервать",
    "kb_proto_quit_no": "↩️ Продолжить практику",
    "flow_proto_hint_one_step_left": "Дальше останется последний шаг практики, затем — короткая оценка по шкале 1–5.",
    "flow_proto_hint_then_rating": "После «Следующий шаг» попросим коротко оценить состояние по шкале 1–5.",
    "nav_quit_proto_prompt": "<b>Прервать практику?</b>\n\nТекущий проход будет сброшен. Это можно начать заново из меню.",
    "callback_quit_continue": "Продолжаем",
...
EN: dict[str, str] = {
    ...
    "kb_proto_quit_ask": "⏹ Stop practice",
    "kb_proto_quit_yes": "✋ Yes, stop",
    "kb_proto_quit_no": "↩️ Keep going",
    "flow_proto_hint_one_step_left": "One more practice step left, then a short 1–5 check-in.",
    "flow_proto_hint_then_rating": "After “Next step” we’ll ask for a quick 1–5 rating.",
    "nav_quit_proto_prompt": "<b>Stop the practice?</b>\n\nThis run will reset. You can start again from the menu.",
    "callback_quit_continue": "Continuing",
